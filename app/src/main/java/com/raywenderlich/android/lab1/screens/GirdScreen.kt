...
@Composable
fun GridView(columnsCount: Int){ val itemSize = items.size
    val rowCount = ceil(itemSize.toFloat() / columnsCount).toInt()
    ...
    for(i in 0 until  rowCount) {
        ...
        val itemsToFill = columnsCount - rowItem.size
